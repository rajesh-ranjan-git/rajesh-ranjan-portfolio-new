...
export const AWS_SES_REGION = process.env.NEXT_PUBLIC_AWS_SES_REGION;
export const AWS_EMAIL_FROM = process.env.NEXT_PUBLIC_AWS_EMAIL_FROM;
export const AWS_EMAIL_TO = process.env.NEXT_PUBLIC_AWS_EMAIL_TO;
export const AWS_DEV_EMAIL_OVERRIDE =
  process.env.NEXT_PUBLIC_AWS_DEV_EMAIL_OVERRIDE;
