    ...
    <section id="education">
      ...
      <div className="justify-center items-center gap-8 grid grid-cols-1 lg:grid-cols-2 w-full">
        {ownerConfig.education.college ? (
          <div className="group before:absolute relative before:inset-0 flex items-center bg-white before:bg-[url('/assets/background/education-bg.jpg')] before:bg-position-[-1rem] before:bg-no-repeat before:opacity-10 shadow-lg mt-36 md:mt-0 md:ml-20 py-8 md:py-16 pt-36 pr-8 pl-8 md:pl-52 rounded-2xl before:rounded-2xl before:bg-size-[200%] text-black before:content-[''] before:pointer-events-none lg:64">
