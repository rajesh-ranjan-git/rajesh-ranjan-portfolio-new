...
const Greetings = () => {
  return (
    <section
      className={`before:block before:absolute relative before:inset-0 flex justify-around items-center before:opacity-100 pr-2 md:pr-10 pl-6 w-screen min-h-screen max-h-screen overflow-hidden ${greetingsStyles.greetings}`}
    >
      ...
      <GreetingsBg />
      <div className="flex flex-col justify-center gap-6 w-full lg:w-[60%] h-full grow">
        <GreetingsText />
        <SocialMedia />
