import "@/components/greetings-img/greetings-img.css";
...
const GreetingsImg = () => {
  return (
    <svg
      ...
      className="w-[30em] md:w-[15em] lg:w-[50em] xl:w-[50rem] h-[30em] md:h-[30em] lg:h-[35rem] xl:h-[50rem]"
    >
      <path
        ...
        fill={theme.accentColorTransparent}
        opacity="0.0"
        id="path13"
      />
      <g id="tshirt">
