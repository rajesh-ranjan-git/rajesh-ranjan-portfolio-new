...
const PersonalInfoText = () => {
  return (
    <div className="flex flex-col gap-2 lg:gap-6 lg:p-10 py-2 text-md md:text-lg lg:text-xl">
      ...
      <ul>
        <li>
          <FontAwesomeIcon icon={faAngleRight} /> <strong>Organization:</strong>{" "}
          India Today Group
        </li>
        <li>
          <FontAwesomeIcon icon={faAngleRight} /> <strong>Designation:</strong>{" "}
          Full Stack Developer
        </li>
        <li>
          <FontAwesomeIcon icon={faAngleRight} /> <strong>Birthday:</strong> 18
        ...
        <li>
          ...
          B.Tech{" "}
          <span className="text-nowrap">(Computer Science & Engineering)</span>
        </li>
        <li>
